...
from dataset.pipeline import IMAGE_LEVEL_TRAIN, IMAGE_LEVEL_VAL, SEMANTIC_TRAIN
import argparse
import cv2 as cv
import torch
...
def main(rank, args):
    ...
    imagenet = "/home/zeyu_yan/.cache/torch/hub/checkpoints/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz"
    backbone.init_params(imagenet)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cuda_visible_devices', type=str, default="4,5")
    parser.add_argument("--work_dir", default="work_dir_tmp", type=str)
    parser.add_argument("--lr", type=float, default=3e-4 / 2, help="learning rate")
    parser.add_argument("--batch_size", type=int, default=8, help="batch size")
    parser.add_argument("--epochs", type=int, default=60, help="epoch num")
